...
export default function MotorCard({ motor }) {
    ...
    `}>
            ...
            <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono text-FAB_05-muted uppercase tracking-wider">
                    {motor.label}
                </span>
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex-1">
                    <div className="h-1.5 bg-FAB_05-bg rounded-full overflow-hidden">
                        <div
                ...
                <span className="text-xs font-mono text-FAB_05-text min-w-[36px] text-right">
                    {motor.speed}
                </span>
            </div>

            {/* Bank label */}
            <div className="text-[9px] font-mono text-FAB_05-muted/50 uppercase">
